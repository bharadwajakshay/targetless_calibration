...
if not os.path.exists(savepath + "_sync/depth_maps_2"):
    os.makedirs(savepath + "_sync/depth_maps_2")

if not os.path.exists(savepath + "_sync/intensity_maps_2"):
    os.makedirs(savepath + "_sync/intensity_maps_2")

if not os.path.exists(savepath + "_sync/target_imgs_2"):
    os.makedirs(savepath + "_sync/target_imgs_2")

if not os.path.exists(savepath + "_sync/depth_maps_transformed_2"):
    os.makedirs(savepath + "_sync/depth_maps_transformed_2")

if not os.path.exists(savepath + "_sync/intensity_maps_transformed_2"):
    os.makedirs(savepath + "_sync/intensity_maps_transformed_2")

depth_maps_folder = savepath + "_sync/depth_maps_2"
intensity_maps_folder = savepath + "_sync/intensity_maps_2"
target_img_folder = savepath + "_sync/target_imgs_2"
depth_maps_transformed_folder = savepath + "_sync/depth_maps_transformed_2"
intensity_maps_transformed_folder = savepath + "_sync/intensity_maps_transformed_2"
...
angle_limit = 0.174532925199433/2.50
tr_limit = 0.2
